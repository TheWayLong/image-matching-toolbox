...
# R2D2 Symbolic  links
ln -sf ../third_party/r2d2/models  r2d2
...
ln -sf ../third_party/patch2pix/pretrained patch2pix
cd patch2pix
bash download.sh
cd ..
...
gdown --id 1kW2bQejjMlmE7FGberHrubXpE_ttX2LB -O loftr/indoor_ot.ckpt
...
ln -sf ../third_party/aspanformer/weights  aspanformer
